...
public interface IScheduleRepository extends JpaRepository<Schedule, Integer> {
    ...
    @Query("SELECT DISTINCT s.startDate FROM Schedule s WHERE s.movie.id=:movieId AND s.branch.id" +
            "= :branchId ")
    List<LocalDate> getStartDateByMovie_IdAndBranch_IdAndStartDate(@Param("movieId") Integer movieId
            , @Param("branchId") Integer branchId);
