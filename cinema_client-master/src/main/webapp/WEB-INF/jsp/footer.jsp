...
<head>
    ...
    <style>
        ...
        ul.social-footer2 li a {display: block;	height:30px;width: 30px;text-align: center; margin-left: -6px;}
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="widget subscribe no-box">
                        <h5 class="widget-title">FoxCinema<span></span></h5>
                        <p>Cinema Tickets Booking Website By Duy Nguyen</p>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <p>Copyright FoxCinema 2022. All rights reserved.</p>
                </div>
            </div>
        </div>
    </div>
