...
@NamedQueries(value = {
        ...
        , @NamedQuery(name = "Ticket.findByTicketBookingTime", query = "SELECT t FROM Ticket t WHERE t.ticketBookingTime = :ticketBookingTime")
        , @NamedQuery(name = "Ticket.findByPay", query = "SELECT t FROM Ticket t WHERE t.pay = :pay")
        , @NamedQuery(name = "Ticket.findByTotalPrice", query = "SELECT t FROM Ticket t WHERE t.totalPrice = :totalPrice")
        , @NamedQuery(name = "Ticket.findByPriceHasDropped", query = "SELECT t FROM Ticket t WHERE t.priceHasDropped = :priceHasDropped")
