...
@NamedQueries({
    ...
    , @NamedQuery(name = "Contact.findByCemail", query = "SELECT c FROM Contact c WHERE c.cemail = :cemail")
    , @NamedQuery(name = "Contact.findByCphone", query = "SELECT c FROM Contact c WHERE c.cphone = :cphone")
    , @NamedQuery(name = "Contact.findByCcontent", query = "SELECT c FROM Contact c WHERE c.ccontent = :ccontent")})
