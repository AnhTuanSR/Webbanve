...
@NamedQueries({
    ...
    , @NamedQuery(name = "MembershipCard.findByCardno", query = "SELECT m FROM MembershipCard m WHERE m.cardno = :cardno")
    , @NamedQuery(name = "MembershipCard.findByTotalspend", query = "SELECT m FROM MembershipCard m WHERE m.totalspend = :totalspend")
    , @NamedQuery(name = "MembershipCard.findByDateregister", query = "SELECT m FROM MembershipCard m WHERE m.dateregister = :dateregister")
    , @NamedQuery(name = "MembershipCard.findByPoint", query = "SELECT m FROM MembershipCard m WHERE m.point = :point")})
